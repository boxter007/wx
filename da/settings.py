...
SECRET_KEY = 'h2r3&7aavkj!**-5^kv5o+^%51mfz5kiy=q=+-5@d-zi9h%19u'
...
LOGGING = {
    ...
    'formatters': {
        ...
        'standard': {
            'format':
            '[%(asctime)s.%(msecs)03d+0800][%(threadName)s:%(thread)d][%(filename)s:%(lineno)d][%(funcName)s][%(levelname)s]%(message)s',
